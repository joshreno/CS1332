...
public class MaxPriorityQueue<T extends Comparable<? super T>>
    ...
    public void enqueue(T item) {
        // The exception is the same for the add
        // method in both the Heap and PriorityQueue
        // I added a class-specific message
        if (item == null) {
            throw new IllegalArgumentException(
                    "Cannot add null data to MaxPriorityQueue");
        }
    ...
    @Override
    public T dequeue() {
        // The exception is the same for the remove
        // method in both the Heap and PriorityQueue
        // I added a class-specific message
        if (isEmpty()) {
            throw new NoSuchElementException(
                    "MaxPriorityQueue is empty");
        }
